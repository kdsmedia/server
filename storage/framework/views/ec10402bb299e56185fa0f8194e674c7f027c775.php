                ...
                <div class="sidebar-block">
                    <div class="bet-component">
                        <div class="bet-form">
                            ...
                            <button type="button" class="btn btn-green btn-play"><span>Place bet</span></button>
                        </div>
				...
				<div class="game_Wheel">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Min. amount: <span id="minBet"><?php echo e($settings->battle_min_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Max. amount: <span id="maxBet"><?php echo e($settings->battle_max_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
						...
						<div class="wheel-content">
							...
							<div class="time">
								<div class="block">
									...
									<div class="line"></div>
									<div class="title">Before the start of the</div>
								...
								<td class="username">
									<button type="button" class="btn btn-link" data-id="<?php echo e($b->user->unique_id); ?>">
										<span class="sanitize-user">
											...
											<span class="sanitize-name" style="<?php echo e($b->css); ?>"><?php echo e($b->user->username); ?></span>
										</span>
									</button>
								</td>
								<td>
