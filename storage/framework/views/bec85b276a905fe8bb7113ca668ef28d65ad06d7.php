				...
				<div class="game_Wheel">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Min. amount: <span id="minBet"><?php echo e($settings->wheel_min_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Max. amount: <span id="maxBet"><?php echo e($settings->wheel_max_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
								...
								<td class="username">
									<button type="button" class="btn btn-link" data-id="<?php echo e($bet->unique_id); ?>">
										<span class="sanitize-user">
											...
											<span class="sanitize-name" style="<?php echo e($bet->css); ?>"><?php echo e($bet->username); ?></span>
										</span>
									</button>
								</td>
								<td>
