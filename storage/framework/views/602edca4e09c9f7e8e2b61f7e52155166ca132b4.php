...
<div class="kt-subheader kt-grid__item" id="kt_subheader">
	<div class="kt-subheader__main">
		<h3 class="kt-subheader__title">Withdraw</h3>
	</div>
</div>
			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="dtable">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo e($withdraw['system']); ?> (Withdraw: XMPay)</td>
						<td><?php echo e($withdraw['wallet']); ?></td>
						<td><div class="row text-center"><div class="col-md-6"><a href="/admin/withdraw/<?php echo e($withdraw['id']); ?>" class="btn btn-success btn-sm">Confirm</a></div><div class="col-md-6"><a href="/admin/return/<?php echo e($withdraw['id']); ?>" class="btn btn-danger btn-sm">Cancel</a></div></div></td>
					</tr>
			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="dtable2">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo e($finish['system']); ?> (Withdraw: XMPay)</td>
