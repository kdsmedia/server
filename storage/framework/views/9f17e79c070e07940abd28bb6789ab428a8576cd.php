				...
				<div class="tab-content">
						...
						<div class="kt-section">
							...
							<div class="form-group row">
								<div class="col-lg-4">
									...
									<input type="text" class="form-control" placeholder="Luck2x.com" value="<?php echo e($settings->domain); ?>" name="domain">
								</div>
								<div class="col-lg-4">
									<label>Site Name:</label>
									<input type="text" class="form-control" placeholder="Luck2x.com" value="<?php echo e($settings->sitename); ?>" name="sitename">
								</div>
								<div class="col-lg-4">
									<label>Site title (title):</label>
									<input type="text" class="form-control" placeholder="Luck2x.com - short description" value="<?php echo e($settings->title); ?>" name="title">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-lg-4">
									<label>Description for search engines:</label>
									<input type="text" class="form-control" placeholder="Description for the website..." value="<?php echo e($settings->description); ?>" name="description">
								</div>
								<div class="col-lg-4">
									<label>Keywords for search engines:</label>
									<input type="text" class="form-control" placeholder="site, name, domain, etc...." value="<?php echo e($settings->keywords); ?>" name="keywords">
								</div>
								<div class="col-lg-4">
									<label>Replacing censorious words in chat with:</label>
									<input type="text" class="form-control" placeholder="i ❤ luck2x" value="<?php echo e($settings->censore_replace); ?>" name="censore_replace">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-lg-4">
									...
									<select class="form-control" name="fakebets">
										<option value="0" <?php echo e(($settings->fakebets == 0) ? 'selected' : ''); ?>>Off</option>
										<option value="1" <?php echo e(($settings->fakebets == 1) ? 'selected' : ''); ?>>Included</option>
									</select>
								</div>
								<div class="col-lg-4">
							...
							<div class="form-group row">
								...
								<div class="col-lg-4">
									...
									<select class="form-control" name="site_disable">
										<option value="0" <?php echo e(($settings->site_disable == 0) ? 'selected' : ''); ?>>Off</option>
										<option value="1" <?php echo e(($settings->site_disable == 1) ? 'selected' : ''); ?>>On</option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="kt-section">
							...
							<div class="form-group row">
								<div class="col-lg-4">
									...
									<input type="text" class="form-control" placeholder="Enter the amount" value="<?php echo e($settings->min_dep); ?>" name="min_dep">
								</div>
								<div class="col-lg-4">
									<label>Amount of deposits to make a withdrawal:</label>
									<input type="text" class="form-control" placeholder="Enter the amount" value="<?php echo e($settings->min_dep_withdraw); ?>" name="min_dep_withdraw">
								</div>
								<div class="col-lg-4">
									<label>How much to give of the deposit amount (1/N):</label>
									<input type="text" class="form-control" placeholder="Enter the amount" value="<?php echo e($settings->profit_koef); ?>" name="profit_koef">
								</div>
							</div>
						</div>
						<div class="kt-section">
						...
						<div class="kt-section">
							...
							<div class="form-group row">
								<div class="col-sm-1-5">
									...
									<input type="text" class="form-control" name="qiwi_com_rub" value="<?php echo e($settings->qiwi_com_rub); ?>" placeholder="Euro">
									<label>QIWI Min. amount</label>
									<input type="text" class="form-control" name="qiwi_min" value="<?php echo e($settings->qiwi_min); ?>" placeholder="Min. amount">
								</div>
								<div class="col-sm-1-5">
									<label>Yandex (+%)</label>
									...
									<input type="text" class="form-control" name="yandex_com_rub" value="<?php echo e($settings->yandex_com_rub); ?>" placeholder="Euro">
									<label>Yandex Min. amount</label>
									<input type="text" class="form-control" name="yandex_min" value="<?php echo e($settings->yandex_min); ?>" placeholder="Min. amount">
								</div>
								<div class="col-sm-1-5">
									...
									<input type="text" class="form-control" name="webmoney_com_rub" value="<?php echo e($settings->webmoney_com_rub); ?>" placeholder="Euro">
									<label>WebMoney Min. amount</label>
									<input type="text" class="form-control" name="webmoney_min" value="<?php echo e($settings->webmoney_min); ?>" placeholder="Min. amount">
								</div>
								<div class="col-sm-1-5">
									<label>VISA (+%)</label>
									...
									<input type="text" class="form-control" name="visa_com_rub" value="<?php echo e($settings->visa_com_rub); ?>" placeholder="Euro">
									<label>VISA Min. amount</label>
									<input type="text" class="form-control" name="visa_min" value="<?php echo e($settings->visa_min); ?>" placeholder="Min. amount">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="kt-section">
							...
							<div class="form-group row">
								...
								<div class="col-lg-3">
									...
									<input type="text" class="form-control" name="bets_<?php echo e($r->name); ?>" value="<?php echo e($r->bets); ?>" placeholder="Max. number of bets for a player">
								</div>
							</div>
						</div>
					...
					<div class="tab-pane" id="pvp" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-4">
								<label>The Game Commission's %:</label>
								<input type="text" class="form-control" placeholder="Max. number of active games per player" value="<?php echo e($settings->flip_commission); ?>" name="flip_commission">
							</div>
							<div class="col-lg-4">
								<label>Minimum bet amount:</label>
					...
					<div class="tab-pane" id="battle" role="tabpanel">
						<div class="form-group row">
							...
							<div class="col-lg-3">
								<label>The Game Commission's %:</label>
								<input type="text" class="form-control" placeholder="The Game Commission's %" value="<?php echo e($settings->battle_commission); ?>" name="battle_commission">
							</div>
						</div>
					</div>
					...
					<div class="tab-pane" id="hilo" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-3">
								<label>Timer:</label>
								<input type="text" class="form-control" placeholder="Timer" value="<?php echo e($settings->hilo_timer); ?>" name="hilo_timer">
							</div>
							<div class="col-lg-3">
								<label>Minimum bet amount:</label>
								<input type="text" class="form-control" placeholder="Minimum bet amount" value="<?php echo e($settings->hilo_min_bet); ?>" name="hilo_min_bet">
							</div>
							<div class="col-lg-3">
								<label>Maximum bet amount:</label>
								<input type="text" class="form-control" placeholder="Maximum bet amount" value="<?php echo e($settings->hilo_max_bet); ?>" name="hilo_max_bet">
							</div>
							<div class="col-lg-3">
								<label>Number of bets for 1 player:</label>
								<input type="text" class="form-control" placeholder="Number of bets" value="<?php echo e($settings->hilo_bets); ?>" name="hilo_bets">
							</div>
						</div>
					</div>
					<div class="tab-pane" id="tower" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-3">
								<label>Minimum bet amount:</label>
								<input type="text" class="form-control" placeholder="Minimum bet amount" value="<?php echo e($settings->tower_min_bet); ?>" name="tower_min_bet">
							</div>
							<div class="col-lg-3">
								<label>Maximum bet amount:</label>
								<input type="text" class="form-control" placeholder="Maximum bet amount" value="<?php echo e($settings->tower_max_bet); ?>" name="tower_max_bet">
							</div>
						</div>
					</div>
					<div class="tab-pane" id="fake" role="tabpanel">
						<div class="form-group row">
							<div class="col-lg-6">
								...
								<input type="text" class="form-control" placeholder="Minimum bet amount for a fake" value="<?php echo e($settings->fake_min_bet); ?>" name="fake_min_bet">
							</div>
							<div class="col-lg-6">
								<label>Maximum bet amount for a fake:</label>
								<input type="text" class="form-control" placeholder="Maximum bet amount for a fake" value="<?php echo e($settings->fake_max_bet); ?>" name="fake_max_bet">
							</div>
						</div>
					</div>
				</div>
