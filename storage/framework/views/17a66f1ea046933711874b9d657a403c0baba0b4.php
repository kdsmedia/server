...
<script src="/js/roulette.js?v=<?php echo e(time()); ?>"></script>
<style>
    .double-loop {
    font-weight: 700;
    max-width: 800px;
...
<div class="game-block">
        <div class="double">
                ...
                <div class="double-time is-countdown" id="timer3">
                    <span class="countdown-row countdown-show1">
                        <span class="countdown-section">
                            <span class="countdown-amount" id="rez-numbr"><?php echo e($settings->roulette_timer); ?></span>
            ...
            <div class="double-row" id="reletteact" style="transform: rotate(<?php echo e($rotate); ?>deg); transition: -webkit-transform 10000ms cubic-bezier(0.32, 0.64, 0.45, 1);"><img src="/img/double-row.png" alt=""></div>
        ...
        <?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a class="double-last-i <?php echo e($l->winner_color); ?>"><?php echo e($l->winner_num); ?></a>
        ...
        <div class="rates-full">
            <div class="rates-loop" data-type="red">
                <div class="rates-top"><div>TOTAL BET: <span class="bet" id="bank_red"><?php echo e((isset($prices['red'])) ? $prices['red'] : 0); ?></span></div></div>
                ...
                <?php $__currentLoopData = $bets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($bet->type == 'red'): ?>
                    <div class="rates-i" data-userid="<?php echo e($bet->user_id); ?>">
                        <div class="rates-ava">
                            <img src="<?php echo e($bet->avatar); ?>">
                        </div>
                        <div class="hidden">
                            <div class="rates-login"><b class="ell"><?php echo e($bet->username); ?></b></div>
                            <div class="rates-rub"><?php echo e($bet->value); ?></div>
                        </div>
                    </div>
            ...
            <div class="rates-loop" data-type="green">
                <div class="rates-top"><div>TOTAL BET: <span class="bet" id="bank_green"><?php echo e((isset($prices['green'])) ? $prices['green'] : 0); ?></span></div></div>
            ...
            <div class="rates-loop" data-type="black">
                <div class="rates-top"><div>TOTAL BET: <span class="bet" id="bank_black"><?php echo e((isset($prices['black'])) ? $prices['black'] : 0); ?></span></div></div>
