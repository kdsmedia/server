...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title><?php echo e($settings->sitename); ?> | Admin Panel</title>
					...
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item <?php echo e(Request::is('admin/ranks') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
								...
								<li class="kt-menu__item <?php echo e(Request::is('admin/styles') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
								...
								<li class="kt-menu__item <?php echo e(Request::is('admin/tournaments') ? 'kt-menu__item--active' : ''); ?>" aria-haspopup="true">
