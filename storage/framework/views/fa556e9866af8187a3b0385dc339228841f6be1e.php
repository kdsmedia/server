...
<link rel="stylesheet" href="/css/coinflip.css?v=1">
                ...
                <div class="sidebar-block">
                    <div class="bet-component">
                        <div class="bet-form">
                            ...
                            <button type="button" class="btn btn-green btn-play"><span>Create game</span></button>
                        </div>
				...
				<div class="game-block">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Min. amount: <span id="minBet"><?php echo e($settings->flip_min_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Max. amount: <span id="maxBet"><?php echo e($settings->flip_max_bet); ?></span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
					</div>
                                            ...
                                            <div class="game-coin flip_<?php echo e($rl['id']); ?>">
                                                    ...
                                                    <div class="left">
                                                        <div class="players block">
															<div class="user win">
																...
																<div class="info">
																	<div class="name user-link" data-id="<?php echo e($rl['unique_id']); ?>"><?php echo $rl['username']; ?></div>
                                                    ...
                                                    <div class="right">
                                                        <div class="players block">
                                                            <div class="user">
                                                                ...
                                                                <div class="info">
                                                                    <div class="name">Waiting for an opponent</div>
                                                ...
                                                <div class="bottom">
													<div class="info block">
														<div class="bank">
															<span class="type">Game Bank:</span>
