                    ...
                    <div class="form_info">
                        ...
                        <div class="form_wrapper group" style="display: none">
                        	<div class="form_text">
								...
								<span>and Join <a href="<?php echo e($settings->vk_url); ?>" target="_blank">our VK Group</a></span>
								<br><span>and get up to <strong><?php echo e($max); ?> coins!</strong></span>
                        	</div>
							<div class="form_block">
								<?php if(!$check): ?>
								<div class="form_value"><?php echo e($settings->bonus_group_time); ?> minutes<div class="form_text">reload</div></div>
...
-->
                        <div class="form_wrapper refs" style="display: none">
                            ...
                            Invite <strong><?php echo e($settings->max_active_ref); ?> active referrals <div class="popover-tip-block" id="purposeTip"><div class="popover-tip-icon"><svg class="icon icon-help"><use xlink:href="/img/symbols.svg#icon-help"></use></svg></div></div></strong>
                        		<br> and get up to <strong><?php echo e($max_refs); ?> coins to the bonus account</strong>
                        	</div>
                        	<div class="form_block">
                        		<?php if(!$refLog): ?>
                        		<div class="form_value"><?php echo e($activeRefs); ?> / <?php echo e($settings->max_active_ref); ?><div class="form_text">referrals</div></div>
                        		<span id="spin-wheel-button" class=""><button type="button" class="btn" data-toggle="modal" data-target="#captchaModal">Spin the wheel</button></span>
                        		<?php else: ?>
                ...
                <div class="list_list">
                    ...
                    <div class="list_item group" data-bonus="group">
                        ...
                        <div class="list_text"><span>Join our Telegram channel</span> <span>and get up to <strong><?php echo e($max); ?> coins </strong></span> <span>once per <?php echo e($settings->bonus_group_time); ?> min</span></div>
                    </div>-->
                    <div class="list_item refs" data-bonus="refs">
                        <svg class="icon icon-faucet">
                            <use xlink:href="/img/symbols.svg#icon-faucet"></use>
                        </svg>
                        <div class="list_text"><span>Invite <strong><?php echo e($settings->max_active_ref); ?> referrals</strong> <br> and get up to <strong><?php echo e($max_refs); ?> coins to the bonus account</strong></span></div>
                    </div>
