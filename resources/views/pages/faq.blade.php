    ...
    <div class="faq-component">
        ...
        <div class="faq-item">
            ...
            <div class="faq-content">
                <p>{{$settings->sitename}} - these are exciting and provable fair mini-games.</p>
        ...
        <div class="faq-item">
            ...
            <div class="faq-content">
                ...
                <p>Each user can check the outcome of any game in a completely deterministic way. By providing one parameter, the client hash, to the inputs of the random number generator, {{$settings->sitename}} cannot manipulate the results in its favour.</p>
                <p>The {{$settings->sitename}} random number generator allows each game to request any number of random numbers from a given client starting number, server starting number, and one-time number.</p>
            </div>
        </div>
        <div class="faq-item">
            <div class="caption">
