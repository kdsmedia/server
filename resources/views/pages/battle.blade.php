				...
				<div class="game_Wheel">
					<div class="progress-wrap">
						<div class="progress-item left">
							<div class="title">Min. amount: <span id="minBet">{{$settings->battle_min_bet}}</span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
							<div class="title">Max. amount: <span id="maxBet">{{$settings->battle_max_bet}}</span> <svg class="icon icon-coin"><use xlink:href="/img/symbols.svg#icon-coin"></use></svg></div>
						</div>
								...
								<td class="username">
									<button type="button" class="btn btn-link" data-id="{{$b->user->unique_id}}">
										<span class="sanitize-user">
											...
											<span class="sanitize-name" style="{{ $b->css }}">{{$b->user->username}}</span>
										</span>
									</button>
								</td>
								<td>
