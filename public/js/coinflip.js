	...
	socket.on('new.flip', function (data) {
		if(USER_ID == data.unique_id) {
			var you = '';
				...
				you += '</div>';
				you += '<div class="info">';
				you += '<div class="name user-link" data-id="'+ data.unique_id +'" style="'+ data.style +'">'+ data.username +'</div>';
				...
				you += '</div>';
				you += '<div class="info">';
				you += '<div class="name">Expecting an opponent</div>';
				...
				you += '<div class="bank">';
				you += '<span class="type">Command See:</span>';
		...
		var all = '';
			...
			all += '</div>';
			all += '<div class="info">';
			all += '<div class="name user-link" data-id="'+ data.unique_id +'" style="'+ data.style +'">'+ data.username +'</div>';
			...
			all += '<div class="players block">';
			all += '<div class="user">';
			all += '<button type="button" class="btn btn-primary btn-join" data-id="'+ data.id +'"><span>Enter</span></button>';
			all += '</div>';
			all += '</div>';
			all += '</div>';
			all += '</div>';
			...
			all += '<div class="bank">';
			all += '<span class="type">Game Bank:</span>';
